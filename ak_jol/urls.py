...
urlpatterns = [
    ...
    path('api/question/', views.QuestionListCrateAPIView.as_view()),
    path('api/question/<int:question_id>/', views.QuestionRetrieveUpdateDestroyAPIView.as_view()),
    path('api/question/<int:question_id>/answer/', views.AnswerCreateAPIView.as_view()),
    path('api/question/<int:question_id>/answer/<int:answer_id>/', views.AnswerRetrieveUpdateDestroyAPIView.as_view()),
